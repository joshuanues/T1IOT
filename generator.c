...
void acc_x_generator(){
  // Genera los valores del arreglo de acc_x
...
void acc_y_generator(){
  // Genera los valores del arreglo de acc_y
  for(int n=0; n<1600; n++) {
...
void acc_z_generator(){
  // Genera los valores del arreglo de acc_z
  for(int n=0; n<1600; n++) {
